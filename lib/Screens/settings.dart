                ...
                InkWell(
                  ...
                  child: const Padding(
                    ...
                    child: Row(
                      ...
                      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                      children: [
                        Icon(Icons.settings_suggest_outlined,size: 35,),
                        Column(
                          mainAxisAlignment: MainAxisAlignment.start,
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text("Chat",style: TextStyle(fontSize: 25,fontFamily: 'Classic'),),
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text("Privacy Policy",style: TextStyle(fontSize: 25,fontFamily: 'Classic'),),
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text("Profile",style: TextStyle(fontSize: 25,fontFamily: 'Classic'),),
                  ...
                  child: const Padding(
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text("Settings",style: TextStyle(fontSize: 25,fontFamily: 'Classic'),),
